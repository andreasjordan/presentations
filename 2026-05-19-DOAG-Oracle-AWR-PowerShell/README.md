...
Auch wenn ich in meinen Projekten das kostenpflichtige AWR verwende, so werde im Vortrag auch auf die kostenlose Alternative Statspack eingehen, da viele Konzepte auch darauf anwendbar sind. Natürlich sind die vorgestellten Verfahren auch mit anderen Skript- oder Programmiersprachen realisierbar, die Teilnehmer benötigen keine PowerShell-Kenntnisse und im Vortrag wird auch kein PowerShell-Code gezeigt.

### Link zur Agenda
       
[Hier](https://meine.doag.org/events/doag-datenbank/2026/agenda/#eventDay.all#textSearch.Jordan) kommen Sie zur Agenda der DOAG Datenbanken.

### Folien

[Hier](2026-05-19-DOAG-Oracle-AWR-PowerShell.pdf) finden Sie das PDF mit den Folien des Vortrages.
